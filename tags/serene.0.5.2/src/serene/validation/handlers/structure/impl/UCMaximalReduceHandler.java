...
abstract class UCMaximalReduceHandler extends UniqueChildPatternHandler implements MaximalReduceHandler{
	public UCMaximalReduceHandler(MessageWriter debugWriter){
		super(debugWriter);
	}
