...
public abstract class Pattern extends ParsedComponent{	
	Pattern(Map<String, String> prefixMapping, String xmlBase, String ns, String datatypeLibrary, AttributeInfo[] foreignAttributes, String qName, String location, MessageWriter debugWriter){		
