...
public class UInterleaveHandler extends InterleaveHandler{	
	...
	public UInterleaveHandler getCopy(StackHandler stackHandler, ErrorCatcher errorCatcher){
		UInterleaveHandler copy = pool.getCopy(this, rule, errorCatcher, parent, stackHandler);
	...
	public String toString(){		
		...
		return "UInterleaveHandler  "+rule.toString()+" "+satisfactionLevel+"/"+satisfactionIndicator+"  "+saturationLevel+"/"+saturationIndicator+" contentIndex="+contentIndex;
	}	
