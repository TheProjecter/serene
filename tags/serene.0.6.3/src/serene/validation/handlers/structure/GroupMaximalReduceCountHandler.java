...
public class GroupMaximalReduceCountHandler extends MaximalReduceCountHandler{
    ...
    */	
	...
	public GroupMaximalReduceCountHandler getCopy(IntList reduceCountList, IntList startedCountList, StackHandler stackHandler, ErrorCatcher errorCatcher){
		GroupMaximalReduceCountHandler copy = pool.getCopy(this,
                                                            rule,
                                                            reduceCountList,
                                                            startedCountList,
                                                            errorCatcher,
	...
	*/
	...
	void handleCurrentChildReduce(){
		SPattern pattern = currentChildParticleHandler.getPattern();
	...
	boolean isCurrentChildReduceAcceptable(){
		...
		SPattern currentChildPattern = currentChildParticleHandler.getRule();
	...
	public String toString(){
		...
		return "GroupMaximalReduceCountHandler  "+rule.toString()+" "+satisfactionLevel+"/"+satisfactionIndicator+" "+saturationLevel+"/"+saturationIndicator+" contentIndex="+contentIndex+"   childParticleHandlers="+Arrays.toString(childParticleHandlers);
	}
} 