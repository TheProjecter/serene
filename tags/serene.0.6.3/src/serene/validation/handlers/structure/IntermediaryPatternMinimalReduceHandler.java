...
public class IntermediaryPatternMinimalReduceHandler extends UCMinimalReduceHandler{
    SUniqueChildPattern rule;
    
	IntermediaryPatternMinimalReduceHandler original;
	...
	public IntermediaryPatternMinimalReduceHandler getCopy(StackHandler stackHandler, ErrorCatcher errorCatcher){
		IntermediaryPatternMinimalReduceHandler copy = pool.getCopy(this, rule, errorCatcher, parent, stackHandler);
	...
	public IntermediaryPatternMinimalReduceHandler getCopy(StructureHandler parent, StackHandler stackHandler, ErrorCatcher errorCatcher){
		IntermediaryPatternMinimalReduceHandler copy = pool.getCopy(this, rule, errorCatcher, parent, stackHandler);
		copy.setState(stackHandler, 
					errorCatcher, 
					childParticleHandler, 
	...
	private void setOriginal(IntermediaryPatternMinimalReduceHandler original){
		this.original = original;
	}
	public IntermediaryPatternMinimalReduceHandler getOriginal(){
		return original;
	}
	...
	public String toString(){
		//return "IntermediaryPatternMinimalReduceHandler "+hashCode()+" "+rule.toString()+" contentHandler "+contentHandler.toString();
		return "IntermediaryPatternMinimalReduceHandler  "+rule.toString()+" contentIndex="+contentIndex;
	}
