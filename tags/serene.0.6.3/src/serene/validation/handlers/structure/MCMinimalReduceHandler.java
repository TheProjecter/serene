...
abstract class MCMinimalReduceHandler extends MinimalReduceHandler{
	...
	*/	
	...
	public abstract MCMinimalReduceHandler getCopy(StackHandler stackHandler, ErrorCatcher errorCatcher);
	public abstract MCMinimalReduceHandler getCopy(StructureHandler parent, StackHandler stackHandler, ErrorCatcher errorCatcher);
