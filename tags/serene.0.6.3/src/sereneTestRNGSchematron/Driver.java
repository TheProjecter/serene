...
package sereneTestRNGSchematron;
	...
	*/
	public static void main(String args[]){		
		...
		if(args == null || args.length == 0){
			System.out.println("Usage: java sereneTestSchematron.Driver [a] test-directory [-d destination-directory-name] [-r result-file-name] [-x xml-file name]."
				+"\n"
		...
		if(destinationDirName.endsWith(File.separator)){
			...
			destinationDirName = destinationDirName + File.separator + "testSuiteRNGSchematron_"+runId+tail;
		}
		...
		if(analyse){
			...
			destinationDirName = destinationDirName.substring(0, destinationDirName.indexOf("testSuite")+37);
