...
public class Interleave extends MultipleChildrenPattern{	
	Interleave(Map<String, String> prefixMapping, String xmlBase, String ns, String datatypeLibrary, AttributeInfo[] foreignAttributes, ParsedComponent[] children, String qName, String location, 
