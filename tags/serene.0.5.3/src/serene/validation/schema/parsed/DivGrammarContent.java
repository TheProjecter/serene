...
public class DivGrammarContent extends Div implements GrammarContent{
	DivGrammarContent(Map<String, String> prefixMapping, String xmlBase, String ns, String datatypeLibrary, AttributeInfo[] foreignAttributes, ParsedComponent[] children, String qName, String location, MessageWriter debugWriter){
