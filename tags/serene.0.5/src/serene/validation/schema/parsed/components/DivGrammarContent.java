...
public class DivGrammarContent extends Div implements GrammarContent{
	GrammarContent[] children;	
	public DivGrammarContent(Map<String, String> prefixMapping, String xmlBase, String ns, String datatypeLibrary, GrammarContent[] children, String qName, String location, MessageWriter debugWriter){
		super(prefixMapping, xmlBase, ns, datatypeLibrary, qName, location, debugWriter);
		asParent(children);
	}
	
	protected void asParent(GrammarContent[] children){
	...
	public GrammarContent[] getChildren(){
		return children;
	}
	
	public GrammarContent getChild(int childIndex){
