...
public class ExternalRef extends AbstractNoChildrenPattern{
	String href;
	
	public ExternalRef(Map<String, String> prefixMapping, String xmlBase, String ns, String datatypeLibrary, String href, String qName, String location, MessageWriter debugWriter){
