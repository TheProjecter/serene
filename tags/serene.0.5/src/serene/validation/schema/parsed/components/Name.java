...
public class Name extends NameClass{	
	...
	public Name(Map<String, String> prefixMapping, String xmlBase, String ns, String datatypeLibrary, String characterContent, String qName, String location, MessageWriter debugWriter){
