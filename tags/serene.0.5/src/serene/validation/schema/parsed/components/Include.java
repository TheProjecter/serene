...
public class Include extends AbstractParsedComponent implements GrammarContent{

	String href;
	IncludeContent[] children;
	
	public Include(Map<String, String> prefixMapping, String xmlBase, String ns, String datatypeLibrary, String href, IncludeContent[] children, String qName, String location, MessageWriter debugWriter){
