...
public interface Datatype {
	...
	/**
	 * Indicates that the datatype does not have ID/IDREF semantics.
	 * 
	 ...
	 * 
	 * @return
	 *		If this datatype does not have any ID/IDREF semantics,
	 ...
	 * does not need a context object when validating unprefixed
