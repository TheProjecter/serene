...
public class ElementWithNameClass extends Element{
	NameClass nameClass;
	public ElementWithNameClass(Map<String,	String> prefixMapping, 
							String xmlBase, 
							String ns, 
	...
	public String toString(){
		String s = "ElementWithNameClass "+nameClass.toString()+" "+qName+" at "+location;				
		return s;
	}
}