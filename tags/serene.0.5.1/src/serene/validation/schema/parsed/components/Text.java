...
public class Text extends AbstractNoChildrenPattern{
	
	public Text(Map<String, String> prefixMapping, String xmlBase, String ns, String datatypeLibrary, String qName, String location, MessageWriter debugWriter){
