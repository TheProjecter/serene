...
public class Grammar extends Pattern{	
	...
	public Grammar(Map<String, String> prefixMapping, String xmlBase, String ns, String datatypeLibrary, GrammarContent[] children, String qName, String location, MessageWriter debugWriter){
