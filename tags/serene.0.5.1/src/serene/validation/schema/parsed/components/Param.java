...
public class Param extends AbstractParsedComponent{
	String name;
	String charContent;
		
	public Param(Map<String, String> prefixMapping, String xmlBase, String ns, String datatypeLibrary, String name, String charContent, String qName, String location, MessageWriter debugWriter){
