...
public class InterleaveMaximalReduceHandler extends MCMaximalReduceHandler{
	...
	InterleaveMaximalReduceHandler(MessageWriter debugWriter){
		super(debugWriter);
	...
	public InterleaveMaximalReduceHandler getCopy(StackHandler stackHandler, ErrorCatcher errorCatcher){
		InterleaveMaximalReduceHandler copy = ((AInterleave)rule).getStructureHandler(errorCatcher, (MaximalReduceHandler)parent, stackHandler);
	...
	public String toString(){		
		...
		return "InterleaveMaximalReduceHandler  "+rule.toString()+" "+satisfactionLevel+"/"+satisfactionIndicator+" contentHandler "+contentHandler.toString();
	}
