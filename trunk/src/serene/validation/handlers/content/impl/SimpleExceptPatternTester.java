...
class SimpleExceptPatternTester extends ExceptPatternTesterState implements ErrorCatcher{
	
	SimpleExceptPatternTester(MessageWriter debugWriter){
		super(debugWriter);
	...
	public void handleChars(char[] chars, StructuredDataActiveType type){
		...
		stackHandler = null;
		if(hasError)totalCharsItemMatches.add(data);
	}
