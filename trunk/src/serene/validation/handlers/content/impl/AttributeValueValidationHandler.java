...
class AttributeValueValidationHandler extends AbstractCVH{
	...
	void reportDatatypeError(DatatypedActiveTypeItem item, String message){
		errorCatcher.attributeValueDatatypeError(validationItemLocator.getQName(), validationItemLocator.getSystemId(), validationItemLocator.getLineNumber(), validationItemLocator.getColumnNumber(), item, message);
	}
	
	void reportValueError(AValue value){
		errorCatcher.attributeValueValueError(validationItemLocator.getQName(), validationItemLocator.getSystemId(), validationItemLocator.getLineNumber(), validationItemLocator.getColumnNumber(), value);
	}
