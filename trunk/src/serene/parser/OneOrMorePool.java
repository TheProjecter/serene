...
public class OneOrMorePool extends RNGParseEndElementTaskPool{
	...
	public OneOrMoreTask getTask(){
		if(taskFree == 0){			
			return new OneOrMoreTask(ns, datatypeLibrary, foreign, this, debugWriter);			
		}
		else{				
	...
	public void recycle(ElementTask t){
		if(!(t instanceof OneOrMoreTask)) throw new IllegalStateException();
		recycle((OneOrMoreTask)t);
	}
