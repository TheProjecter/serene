...
public class InterleavePool extends RNGParseEndElementTaskPool{
	...
	public InterleaveTask getTask(){
		if(taskFree == 0){			
			return new InterleaveTask(ns, datatypeLibrary, foreign, this, debugWriter);			
		}
		else{				
	...
	public void recycle(ElementTask t){
		if(!(t instanceof InterleaveTask)) throw new IllegalStateException();
		recycle((InterleaveTask)t);
	}
