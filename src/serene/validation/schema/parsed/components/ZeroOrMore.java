...
public class ZeroOrMore extends AbstractMultipleChildrenPattern{
	
	public ZeroOrMore(Map<String, String> prefixMapping, String xmlBase, String ns, String datatypeLibrary, Pattern[] children, String qName, String location, MessageWriter debugWriter){
