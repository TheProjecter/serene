...
public class Mixed extends AbstractMultipleChildrenPattern{
	
	public Mixed(Map<String, String> prefixMapping, String xmlBase, String ns, String datatypeLibrary, Pattern[] children, String qName, String location, MessageWriter debugWriter){
