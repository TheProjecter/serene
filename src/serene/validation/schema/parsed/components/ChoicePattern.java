...
public class ChoicePattern extends AbstractMultipleChildrenPattern{		
	public ChoicePattern(Map<String, String> prefixMapping, String xmlBase, String ns, String datatypeLibrary, Pattern[] children, String qName, String location, 
