...
public class Optional extends AbstractMultipleChildrenPattern{
	
	public Optional(Map<String, String> prefixMapping, String xmlBase, String ns, String datatypeLibrary, Pattern[] children, String qName, String location, MessageWriter debugWriter){
