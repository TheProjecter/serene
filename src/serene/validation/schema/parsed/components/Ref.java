...
public class Ref extends AbstractInternalRefPattern{
	public Ref(Map<String, String> prefixMapping, String xmlBase, String ns, String datatypeLibrary, String name, String qName, String location,  
