...
public class Empty extends AbstractNoChildrenPattern{
	
	public Empty(Map<String, String> prefixMapping, String xmlBase, String ns, String datatypeLibrary, String qName, String location, MessageWriter debugWriter){
