...
public class AnyName extends AbstractWildCard{		
	public AnyName(Map<String, String> prefixMapping, String xmlBase, String ns, String datatypeLibrary, ExceptNameClass child, String qName, String location,  
