...
public class InterleaveMinimalReduceHandler extends MCMinimalReduceHandler{
	...
	public InterleaveMinimalReduceHandler getCopy(StackHandler stackHandler, ErrorCatcher errorCatcher){
		InterleaveMinimalReduceHandler copy = pool.getCopy(this, rule, errorCatcher, parent, stackHandler);
	...
	public String toString(){		
		...
		return "InterleaveMinimalReduceHandler  "+rule.toString()+" "+satisfactionLevel+"/"+satisfactionIndicator+" contentIndex="+contentIndex;
	}
} 