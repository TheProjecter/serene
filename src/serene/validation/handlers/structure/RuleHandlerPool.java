...
public abstract class RuleHandlerPool{	
	...
	public abstract ValidatorRuleHandlerPool getValidatorRuleHandlerPool();		
	public abstract void recycle(ValidatorRuleHandlerPool amrhp);
	
	abstract void fill(ValidatorRuleHandlerPool ruleHandlerPool,
	...
	abstract void recycle(int particleHandlerRecycledCount,
