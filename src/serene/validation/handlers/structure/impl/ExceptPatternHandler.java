...
public class ExceptPatternHandler extends StructureValidationHandler{
	...
	void init(AExceptPattern attribute, ErrorCatcher errorCatcher, StackHandler stackHandler){
		this.rule = attribute;
	...
	public ExceptPatternHandler getCopy(StackHandler stackHandler, ErrorCatcher errorCatcher){
		ExceptPatternHandler copy = rule.getStructureHandler(errorCatcher, stackHandler);
	...
	public ExceptPatternHandler getCopy(StructureHandler parent, StackHandler stackHandler, ErrorCatcher errorCatcher){
		throw new IllegalStateException();
	}
	private void setOriginal(ExceptPatternHandler original){
		this.original = original;
	}
	public ExceptPatternHandler getOriginal(){
		return original;
	}
	...
	public String toString(){
		//return "ExceptPatternHandler "+hashCode()+" "+rule.toString()+" contentHandler "+contentHandler.toString();
		return "ExceptPatternHandler  "+rule.toString()+" contentHandler "+contentHandler.toString();
	}
} 