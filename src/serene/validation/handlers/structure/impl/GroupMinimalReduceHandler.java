...
public class GroupMinimalReduceHandler extends MCMinimalReduceHandler{
	...
	GroupMinimalReduceHandler(MessageWriter debugWriter){
		super(debugWriter);
	...
	public GroupMinimalReduceHandler getCopy(StackHandler stackHandler, ErrorCatcher errorCatcher){
		GroupMinimalReduceHandler copy = ((AGroup)rule).getStructureHandler(errorCatcher, 
													(MinimalReduceHandler)parent, 
													stackHandler);
	...
	private void addLastCorrectChildIndex(APattern sourceDefinition){
		...
		childItemId[lastCorrectChildIndexIndex][newIndex] = inputStackDescriptor.getItemId();
	...
	public String toString(){
		...
		return "GroupMinimalReduceHandler  "+rule.toString()+" "+satisfactionLevel+"/"+satisfactionIndicator+" contentHandler "+contentHandler.toString();
	}
} 