...
public class ChoiceMaximalReduceHandler extends UCMaximalReduceHandler{
	...
	public MaximalReduceHandler getChildHandler(Rule child){		
		...
		return (MaximalReduceHandler)childStructureHandler;
	}	
	...
	public ChoiceMaximalReduceHandler getCopy(StackHandler stackHandler, ErrorCatcher errorCatcher){
		ChoiceMaximalReduceHandler copy = ((AChoicePattern)rule).getStructureHandler(errorCatcher, (MaximalReduceHandler)parent, stackHandler);
	...
	public ChoiceMaximalReduceHandler getCopy(StructureHandler parent, StackHandler stackHandler, ErrorCatcher errorCatcher){
		ChoiceMaximalReduceHandler copy = ((AChoicePattern)rule).getStructureHandler(errorCatcher, (MaximalReduceHandler)parent, stackHandler);
		copy.setState(stackHandler, 
					errorCatcher, 
					childParticleHandler, 
	...
	private void setOriginal(ChoiceMaximalReduceHandler original){
		this.original = original;
	}
	public ChoiceMaximalReduceHandler getOriginal(){
		return original;
	}
