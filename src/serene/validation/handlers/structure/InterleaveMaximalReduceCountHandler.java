...
public class InterleaveMaximalReduceCountHandler extends MaximalReduceCountHandler{
	...
	public InterleaveMaximalReduceCountHandler getCopy(IntList reduceCountList, StackHandler stackHandler, ErrorCatcher errorCatcher){
		InterleaveMaximalReduceCountHandler copy = pool.getCopy(this, rule, reduceCountList, errorCatcher, stackHandler);
	...
	public String toString(){		
		...
		return "InterleaveMaximalReduceCountHandler  "+rule.toString()+" "+satisfactionLevel+"/"+satisfactionIndicator+" contentIndex="+contentIndex;
	}
} 