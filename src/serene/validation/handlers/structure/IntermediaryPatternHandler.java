...
public class IntermediaryPatternHandler extends UniqueChildPatternHandler{
    SUniqueChildPattern rule;
    
	IntermediaryPatternHandler original;
	...
	public IntermediaryPatternHandler getCopy(StackHandler stackHandler, ErrorCatcher errorCatcher){
		IntermediaryPatternHandler copy = pool.getCopy(this, rule, errorCatcher, parent, stackHandler);
	...
	public IntermediaryPatternHandler getCopy(StructureHandler parent, StackHandler stackHandler, ErrorCatcher errorCatcher){
		IntermediaryPatternHandler copy = pool.getCopy(this, rule, errorCatcher, (StructureHandler)parent, stackHandler);
		copy.setState(stackHandler, 
					errorCatcher, 
					childParticleHandler, 
					childStructureHandler, 
	...
	private void setOriginal(IntermediaryPatternHandler original){
		this.original = original;
	}
	public IntermediaryPatternHandler getOriginal(){
		return original;
	}
	...
	public String toString(){
		//return "IntermediaryPatternHandler "+hashCode()+" "+rule.toString()+" contentHandler "+contentHandler.toString();
		return "IntermediaryPatternHandler  "+rule.toString()+" contentIndex="+contentIndex;
	}
