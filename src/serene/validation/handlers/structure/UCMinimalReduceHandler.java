...
abstract class UCMinimalReduceHandler extends MinimalReduceHandler{
	...
	public abstract UCMinimalReduceHandler getCopy(StackHandler stackHandler, ErrorCatcher errorCatcher);
	public abstract UCMinimalReduceHandler getCopy(StructureHandler parent, StackHandler stackHandler, ErrorCatcher errorCatcher);
