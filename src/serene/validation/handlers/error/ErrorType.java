...
public interface ErrorType{
	...
	int AMBIGUOUS_ATTRIBUTE_CONTENT_ERROR = 10;    
	int AMBIGUOUS_CHARS_CONTENT_ERROR = 11;
	...
	int AMBIGUOUS_CHARS_CONTENT_WARNING = 3;
	
    int AMBIGUOUS_LIST_TOKEN_IN_CONTEXT_WARNING = 4;
