...
public abstract class ContentHandlerPool{
	...
	public abstract void recycle(ValidatorEventHandlerPool eventHandlerPool);
	
	abstract void fill(ValidatorEventHandlerPool eventHandlerPool,
	...
	abstract void recycle(int elementVHRecycledCount,
